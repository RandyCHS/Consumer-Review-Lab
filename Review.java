 ...
 */
  ...
  */
  ...
  /** Activity 3 fakeReview method
     Write the fakeReview method here which autogenerates a review based on a marked-up/annotated review.
  */
  public static String fakeReview(String filename)
  {
    // read in the file contents into a string

    // loop over the string containing the contents of the marked-up review to build and return a fake review
    String fakeReview = "";

    // returng the fake review
    return fakeReview; 
  }
